(function () {
  ...
  window.SITE_CONFIG = Object.freeze({
    ...
    /* 2026-09-12, the owner's decision: THERE IS NO LONGER A FREE-DELIVERY
       THRESHOLD. (2026-09-15: no surface prices delivery any more, at the owner's instruction; a charge still exists but is at their discretion.) The only way
  ...
  window.PRODUCTS = Object.freeze([
    ...
    product({ id: "tide-simply-oxi-stain-70-loads", sourcePath: "7dolla/1692594.webp", brand: "Tide", name: "Simply Oxi + Stain", variant: "Refreshing Breeze · large bottle", size: "94 fl oz · 70 loads", category: "Liquid detergent", inventoryQuantity: 2, inventoryUnit: "bottles", packaging: "Large yellow bottle · blue/orange label · dosing cap", inventoryStatus: "photo-confirmed", dealGroup: "8-each", comparePrice: 9.38, searchTags: ["tide", "simply", "oxi", "stain", "refreshing breeze", "large", "70 loads"], alt: "Tide Simply Oxi and Stain Refreshing Breeze detergent, 94 fluid ounces and 70 loads" }),
    product({ id: "tide-simply-daybreak-85-loads", sourcePath: "assets/inventory-sources/master-2026-09/tide-simply-daybreak-107oz-edited.png", brand: "Tide", name: "Simply All in One", variant: "Daybreak Fresh", size: "107 fl oz · 85 loads", category: "Liquid detergent", inventoryQuantity: 8, quantityNote: "5 + 3 from Group 2 (2026-09-12) = 8", inventoryUnit: "bottles", packaging: "Large yellow bottle · green label · dosing cap", inventoryStatus: "photo-confirmed", dealGroup: "8-each", comparePrice: 10.48, imageSourceUrl: "https://www.homedepot.com/p/340972664", searchTags: ["tide", "simply", "all in one", "daybreak fresh", "large", "85 loads", "107 oz"], alt: "Tide Simply All in One Daybreak Fresh detergent, 107 fluid ounces and 85 loads" }),
    ...
    product({ id: "suavitel-holiday-white-christmas", sourcePath: "7dolla/0750954665980.png", brand: "Suavitel", name: "Blanca Navidad / White Christmas", variant: "Limited-edition holiday scent", size: "101 fl oz", category: "Fabric softener", inventoryQuantity: 3, inventoryUnit: "bottles", packaging: "White bottle · Christmas/holiday graphics", inventoryStatus: "photo-confirmed", dealGroup: "8-each", comparePrice: 8.47, sourceStatus: "working_value", searchTags: ["suavitel", "blanca navidad", "white christmas", "holiday", "fabric softener", "101 oz"], alt: "Suavitel Blanca Navidad White Christmas holiday fabric softener, 101 fluid ounces" }),
    ...
    product({ id: "tide-simply-daybreak-24-loads", sourcePath: "assets/products-master/tide-simply-daybreak-24-loads.png", brand: "Tide", name: "Simply All in One", variant: "Daybreak Fresh · small bottle", size: "31 fl oz · 24 loads", category: "Liquid detergent", inventoryQuantity: 3, inventoryUnit: "bottles", packaging: "Yellow bottle · green label · clear dosing cap", quantityNote: "3 from Group 2 (2026-09-12)", inventoryStatus: "packshot-confirmed", dealGroup: "2-for-5", comparePrice: 4.39, sourceStatus: "working_value", sourceNote: "Filled 2026-09-15. Deliberately a WORKING VALUE and not a citation. Two live US prices were observed for this exact SKU (UPC 00030772120927): King Kullen $4.79 on a page whose title carries both 31 and 24, and The Fresh Grocer $4.39 on a page whose title omits the 24. The $4.79 page is citable and was rejected anyway: King Kullen is a ~30-store Long Island chain and $4.79 was the TOP of everything observed, so citing it would inflate the saving shown to a shopper in Temecula. comparePrice is the STORE price, so the LOWER figure is the one that cannot overstate. No national retailer stocks this size citably: Target carries no Tide Simply bottle under 84 fl oz, Dollar General lists the SKU with a perfect title but is out of stock and prints no price, and Walmart/ShopRite/CVS/Home Depot block automated reads.", imageSourceType: "Retail packshot, background removed with Vision segmentation", searchTags: ["tide", "simply", "all in one", "daybreak", "green", "24 loads", "31 oz"], alt: "Tide Simply All in One Daybreak Fresh detergent, 31 fluid ounces and 24 loads" }),
    product({ id: "tide-pods-spring-meadow-42ct", sourcePath: "assets/products-master/tide-pods-spring-meadow-42ct.png", brand: "Tide", name: "PODS 3-in-1", variant: "Spring Meadow · Coldwater Clean", size: "32 oz · 42 pacs", category: "Laundry pods", inventoryQuantity: 7, inventoryUnit: "tubs", packaging: "Orange tub · purple label", quantityNote: "7 from Group 2 (2026-09-12)", inventoryStatus: "packshot-confirmed", dealGroup: "8-each", comparePrice: 12.99, sourceRetailer: "Target", sourceUrl: "https://www.target.com/p/tide-pods-laundry-detergent-pacs-spring-meadow-35oz-42ct/-/A-21516453", sourceStatus: "verified", sourceTitle: "Tide Spring Meadow HE Deep Cleaning Concentrated Laundry Detergent Pods 42 Pacs - 32oz : Target", sourcePrice: 12.99, sourceCheckedOn: "2026-09-12", sourceNote: "Opened 2026-09-12 and the live H1 read back. The URL SLUG still says 35oz-42ct from an older packaging generation; the page title says 32oz and the title is what the size guard reads. Target's own specifications block independently states Number of uses: 42.", imageSourceType: "Retail packshot, background removed with Vision segmentation", searchTags: ["tide", "pods", "3 in 1", "spring meadow", "coldwater", "42 pacs", "purple"], alt: "Tide PODS 3-in-1 Spring Meadow laundry pods, 42 pacs" }),
    product({ id: "tide-free-gentle-pods-42ct", sourcePath: "assets/products-master/tide-free-gentle-pods-42ct.png", brand: "Tide", name: "PODS Free & Gentle", variant: "Unscented · no added dyes or perfumes", size: "31 oz · 42 pacs", category: "Laundry pods", inventoryQuantity: 15, inventoryUnit: "tubs", packaging: "White tub · pale-blue label", quantityNote: "11 from Group 2 (2026-09-12) + 4 from Group 3 (2026-09-13) = 15. The owner read 32 oz off the container on 2026-09-13; the VERIFIED Target citation says 42ct/31oz, so `size` still says 31 and the disagreement is recorded here rather than silently resolved.", inventoryStatus: "packshot-confirmed", dealGroup: "8-each", comparePrice: 12.99, sourceRetailer: "Target", sourceUrl: "https://www.target.com/p/tide-pods-free-38-gentle-liquid-laundry-detergent-pacs-42-ct/-/A-50225561", sourceStatus: "verified", sourceTitle: "Tide Pods HE Compatible Laundry Detergent Pacs - Free & Gentle - 42ct/31oz: Dermatologist Tested, Hypoallergenic, Concentrated : Target", sourcePrice: 12.99, sourceCheckedOn: "2026-09-12", sourceNote: "Opened 2026-09-12. The page prints $12.99 ($0.42/ounce) and 12.99/31 = 0.419, so the unit price the retailer prints is arithmetically consistent with a 31 oz tub — a second, independent check that this is the right size. Target offers 31ct, 57ct, 76ct and 112ct from the same page, which is exactly the wrong-size trap five citations fell into before; any recheck must land back on 42ct/31oz.", imageSourceType: "Retail packshot, background removed with Vision segmentation", searchTags: ["tide", "pods", "free gentle", "unscented", "42 pacs", "sensitive"], alt: "Tide PODS Free and Gentle unscented laundry pods, 42 pacs" }),
    product({ id: "gain-flings-original-42ct", sourcePath: "assets/products-master/gain-flings-original-42ct.png", brand: "Gain", name: "flings! Original", variant: "3-in-1 · Oxi Boost + Febreze", size: "42 flings", category: "Laundry pods", inventoryQuantity: 21, inventoryUnit: "tubs", packaging: "Green tub · green lid", quantityNote: "21 from Group 2 (2026-09-12)", inventoryStatus: "packshot-confirmed", dealGroup: "8-each", comparePrice: 11.19, sourceStatus: "working_value", sourceNote: "Filled 2026-09-15. NO citable page exists for the 42 ct: Target's 42 ct page A-23967520 now 404s and its live Gain flings Original listing offers 15/16/31/60/102 ct only; Walmart, CVS, Foods Co and Family Dollar all block automated reads. Derived instead from a Target page that WAS opened the same day -- A-81260470, 60 pacs / 40 oz, $15.99, printing $0.40 per ounce. Two independent routes off that one listing agree: 15.99/60 = $0.2665 per pac x 42 = $11.19, and 40/60 = 0.667 oz per pac so 42 pacs = 28.0 oz x $0.40 = $11.20. It does not overstate: Walmart search metadata showed the 42 ct at $12.48 and our own verified Tide PODS 42 ct is $12.99. WARNING FOR THE NEXT SESSION: our size string is \"42 flings\", whose only numeric token is 42, and Target's SIXTY-count page is slugged ...original-42oz-60ct -- that 42 is OUNCES. Such a page would satisfy the mechanical size guard while citing a pack half again as large. Check any future citation for this row by eye.", imageSourceType: "Retail packshot, background removed with Vision segmentation", searchTags: ["gain", "flings", "original", "oxi", "febreze", "42", "green"], alt: "Gain flings Original laundry detergent pods, 42 flings" }),
    product({ id: "tide-power-pods-oxi-boost-25ct", sourcePath: "assets/products-master/tide-power-pods-oxi-boost-25ct.png", brand: "Tide", name: "Power PODS Oxi Boost", variant: "Set-In Stain Removal + Oxi Power", size: "37 oz · 25 XL pods", category: "Laundry pods", inventoryQuantity: 7, inventoryUnit: "tubs", packaging: "Orange tub · dark-blue label", quantityNote: "7 from Group 2 (2026-09-12)", inventoryStatus: "packshot-confirmed", dealGroup: "8-each", comparePrice: 12.99, sourceRetailer: "Target", sourceUrl: "https://www.target.com/p/tide-oxi-boost-laundry-detergent-power-pods-with-stain-remover-25ct/-/A-93248130", sourceStatus: "verified", sourceTitle: "Tide Oxi Boost Power HE Deep Cleaning Concentrated Laundry Detergent Pods 25 Pacs - 37oz : Target", sourcePrice: 12.99, sourceCheckedOn: "2026-09-12", sourceNote: "Opened 2026-09-12; the H1 names Oxi Boost explicitly. $12.99 ($0.35/ounce) and 12.99/37 = 0.351, consistent with a 37 oz tub. NOT the same citation as tide-power-pods-odor-oxi-25ct, which cites A-84114514 at the same 25/37 — two different products that happen to share a size, deliberately.", imageSourceType: "Retail packshot, background removed with Vision segmentation", searchTags: ["tide", "power pods", "oxi boost", "set in stain", "25 xl", "37 oz"], alt: "Tide Power PODS Oxi Boost laundry pods, 25 XL pods" }),
    product({ id: "tide-power-pods-odor-refresh-free-gentle-25ct", sourcePath: "assets/products-master/tide-power-pods-odor-refresh-free-gentle-25ct.png", brand: "Tide", name: "Power PODS Odor Refresh Free & Gentle", variant: "Unscented", size: "37 oz · 25 XL pods", category: "Laundry pods", inventoryQuantity: 8, inventoryUnit: "tubs", packaging: "White tub · grey lid · teal label", quantityNote: "4 from Group 2 (2026-09-12) + 4 from Group 3 (2026-09-13) = 8", inventoryStatus: "packshot-confirmed", dealGroup: "8-each", comparePrice: 12.99, sourceRetailer: "Target", sourceUrl: TARGET_TIDE_OXI_PODS, sourceStatus: "category_reference", sourceTitle: "Tide Odor + Oxi Original HE Deep Cleaning Concentrated Laundry Detergent Pods: 25 Capsules with Fresh Scent - 37oz : Target", sourcePrice: 12.99, sourceCheckedOn: "2026-09-15", sourceNote: "Filled 2026-09-15. A SIMILAR-SIZE reference and labelled as one on the page, not a price for this item: the size is identical (25 XL pods / 37 oz) but the cited variant is Odor + Oxi scented where ours is Odor Refresh Free & Gentle unscented. No exact-item page can be cited -- Target's only Odor Refresh Free & Gentle pod page is 45 pacs / 66 oz at $19.99, and Walmart and CVS both block automated reads and carry no 37 in their titles regardless. It does not overstate: the exact item showed $12.97 on Instacart the same day, within 0.2%. Shares A-84114514 with tide-power-pods-odor-oxi-25ct deliberately, which the one-source-one-size guard permits because both rows claim the identical size string.", imageSourceType: "Retail packshot, background removed with Vision segmentation", searchTags: ["tide", "power pods", "odor refresh", "free gentle", "unscented", "25 xl"], alt: "Tide Power PODS Odor Refresh Free and Gentle unscented pods, 25 XL pods" }),
